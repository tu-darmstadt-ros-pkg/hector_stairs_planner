...
if LINESEGMENT_MPRIMS == 1
    ...
    %turn in place
    basemprimendpts0_c(2,:) = [0 0 1 turninplacecostmult];
    basemprimendpts0_c(3,:) = [0 0 -1 turninplacecostmult];
    ...
    %turn in place
    basemprimendpts45_c(2,:) = [0 0 1 turninplacecostmult];
    basemprimendpts45_c(3,:) = [0 0 -1 turninplacecostmult];
    ...
    %turn in place
    basemprimendpts22p5_c(2,:) = [0 0 1 turninplacecostmult];
    basemprimendpts22p5_c(3,:) = [0 0 -1 turninplacecostmult]; 
    ...
    %turn in place
    basemprimendpts11p25_c(2,:) = [0 0 1 turninplacecostmult];
    basemprimendpts11p25_c(3,:) = [0 0 -1 turninplacecostmult];  
    ...
    %turn in place
    basemprimendpts33p75_c(2,:) = [0 0 1 turninplacecostmult];
    basemprimendpts33p75_c(3,:) = [0 0 -1 turninplacecostmult];     
